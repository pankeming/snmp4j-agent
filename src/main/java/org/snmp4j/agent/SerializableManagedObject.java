/*_############################################################################
  _## 
  _##  SNMP4J-Agent 3 - SerializableManagedObject.java  
  _## 
...
/**
 * The {@code SerializableManagedObject} interface is implemented by
 * {@code ManagedObject}s whose (data) content can be serialized
...
public interface SerializableManagedObject<SR extends SubRequest<?>> extends RegisteredManagedObject<SR> {
   ...
   * @return
   *    {@code true} if {@link #load} and {@link #save} should not be
   *    called through a persistent storage operation and {@code false}
