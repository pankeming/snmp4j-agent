/*_############################################################################
  _## 
  _##  SNMP4J-Agent 3 - ProxyMap.java  
  _## 
...
/**
 * The <code>ProxyMap</code> maps context engine IDs in conjunction with a proxy usage type to a ProxyForwarder
 * instance.
 *
 * @author Frank Fock
 * @version 1.0
...
public class ProxyMap {
    ...
    static class ProxyKey implements Comparable<ProxyKey> {
