/*_############################################################################
  _## 
  _##  SNMP4J-Agent 3 - TemporaryList.java  
  _## 
...
/**
 * The <code>TemporaryList</code> implements a list whose items are automatically removed after a predefined timeout.
 * When an item is removed by timeout, listener can be called to handle the remove operation.
 *
 * @author Frank Fock
 */
public class TemporaryList<T> {
    ...
    class TemporaryListItem<T> {
        ...
        /**
         * Gets the time of maturity, i.e. the time in nano seconds when this entry may get removed earliest.
         *
         * @return the time of maturity in nanoseconds.
         */
        ...
        /**
         * Checks if the given reference time in nanoseconds is later than the maturity time of this item.
         *
         * @param referenceTime
         *         the reference time in nanoseconds.
         *
         * @return <code>true</code> if the item is subject to removal from list,
