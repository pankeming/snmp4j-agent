...
public interface MOTable<R extends MOTableRow, C extends MOColumn, M extends MOTableModel<R>>
     ...
     *
     * @return a <code>MOColumn</code> instance describing the attributes of requested
     * column.
     */
     ...
     *         cell instance OID.
     *
     * @return a <code>MOTableCellInfo</code> instance with the index, column index
     ...
     *
     * @return the value of the cell or <code>null</code> if such a cell does not
     * exist.
     */
     ...
     *
     * @return the removed row or <code>null</code> if the row cannot be found or
     * cannot be removed.
     */
