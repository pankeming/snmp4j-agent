/*_############################################################################
  _## 
  _##  SNMP4J-Agent 3 - MOValueValidationEvent.java  
  _## 
...
/**
 * The <code>MOValueValidationEvent</code> class represents a value validation request. The request's result is carries
 * in its status member.
 *
 * @author Frank Fock
 * @version 1.0
 */
public class MOValueValidationEvent extends EventObject {
    ...
    private static final long serialVersionUID = -2478939272089379336L;
     ...
     */
    public MOValueValidationEvent(Object source, Variable oldValue, Variable newValue) {
        super(source);
     ...
     *
     * @return an SNMP error status or zero if validation was successful.
     */
