...
/**
 * The {@code MOTableRow} interface describes a conceptual table row.
 *
 * @author Frank Fock
 * @version 2.0.5
 */
public interface MOTableRow {
     ...
     * of an ifTable would return {@code OID("1")}.
     *
     ...
     *
     * @return the base row or {@code null} if this row is a base row itself.
     */
