/*_############################################################################
  _## 
  _##  SNMP4J-Agent 3 - DisplayStringTC.java  
  _## 
...
/**
 * The {@code DisplayStringTC} implements a {@link org.snmp4j.smi.OctetString} {@link TextualConvention} that
...
public class DisplayStringTC implements TextualConvention<OctetString> {
    ...
    public MOScalar<OctetString> createScalar(OID oid, MOAccess access, OctetString value) {
        return new DisplayStringScalar<>(oid, access, ((value == null) ? createInitialValue() : value));
    }
