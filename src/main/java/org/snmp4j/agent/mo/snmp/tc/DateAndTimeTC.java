/*_############################################################################
  _## 
  _##  SNMP4J-Agent 3 - DateAndTimeTC.java  
  _## 
...
public class DateAndTimeTC implements TextualConvention<OctetString> {
    ...
    public MOColumn<OctetString> createColumn(int columnID, int syntax, MOAccess access, OctetString defaultValue,
    ...
    public MOScalar<OctetString> createScalar(OID oid, MOAccess access, OctetString value) {
        return new DateAndTimeScalar<>(oid, access, ((value == null) ? createInitialValue() : value));
