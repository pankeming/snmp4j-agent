/*_############################################################################
  _## 
  _##  SNMP4J-Agent 3 - RowPointer.java  
  _## 
...
public class RowPointer extends MOMutableColumn<OID> {
    ...
    @SuppressWarnings("rawtypes")
    public RowPointer(int columnID, MOAccess access, OID defaultValue, boolean mutableInService, MOTable targetTable) {
        super(columnID, SMIConstants.SYNTAX_OBJECT_IDENTIFIER,
                access, defaultValue, mutableInService);
        this.targetTable = targetTable;
    }

    public RowPointer(int columnID, MOAccess access, OID defaultValue, boolean mutableInService) {
        super(columnID, SMIConstants.SYNTAX_OBJECT_IDENTIFIER,
                access, defaultValue, mutableInService);
    }
