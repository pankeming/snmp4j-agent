/*_############################################################################
  _## 
  _##  SNMP4J-Agent 3 - AgentCapabilityList.java  
  _## 
...
public interface AgentCapabilityList {
     ...
     *
     * @return the index OID of the entry that uniquely identifies it.
     */
     ...
     *
     * @return MOTableRow
     * the removed sysOREntry row or {@code null} if such a row
     * could not be found.
     */
