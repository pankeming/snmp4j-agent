/*_############################################################################
  _## 
  _##  SNMP4J-Agent 3 - SnmpProxyMIB.java  
  _## 
    ...
    private void createSnmpProxyEntry() {
        ...
        snmpProxyEntryColumns[idxSnmpProxyStorageType] =
                new StorageType(colSnmpProxyStorageType,
                        ...
                        new Integer32(3),
                        true);
        snmpProxyEntryColumns[idxSnmpProxyRowStatus] = new RowStatus<SnmpProxyRow>(colSnmpProxyRowStatus);
...
//--AgentGen END
    ...
    /**
     * The <code>SnmpProxyContextEngineIDValidator</code> implements the value validation for
     * <code>SnmpProxyContextEngineID</code>.
     */
    ...
    /**
     * The <code>SnmpProxyContextNameValidator</code> implements the value validation for
     * <code>SnmpProxyContextName</code>.
     */
    ...
    /**
     * The <code>SnmpProxyTargetParamsInValidator</code> implements the value validation for
     * <code>SnmpProxyTargetParamsIn</code>.
     */
    ...
    /**
     * The <code>SnmpProxySingleTargetOutValidator</code> implements the value validation for
     * <code>SnmpProxySingleTargetOut</code>.
     */
    ...
    /**
     * The <code>SnmpProxyMultipleTargetOutValidator</code> implements the value validation for
     * <code>SnmpProxyMultipleTargetOut</code>.
     */
...
//--AgentGen BEGIN=_METHODS
     ...
     */
    @SuppressWarnings("rawtypes")
    public MOTable<SnmpProxyRow, MOColumn, DefaultMOMutableTableModel<SnmpProxyRow>> getSnmpProxyEntry() {
     ...
     *
     * @return <code>true</code> if the row could be added, <code>false</code>
     * otherwise.
     */
     ...
     *
     * @return the removed row or <code>null</code> if no such row exists.
     */
