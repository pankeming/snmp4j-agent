...
/**
 * The {@code ProxyForwarderImpl} class implements a proxy forwarder
...
public class ProxyForwarderImpl implements ProxyForwarder {
    ...
    /**
     * Creates a {@code ProxyForwarder} implementation based on a SNMP
     ...
     *         a SNMP session.
     * @param proxyMIB
     *         a {@code SnmpProxyMIB} implementation with the proxy configuration.
     * @param targetMIB
     *         a {@code SnmpTargetMIB} implementation with the target
     *         configuration.
     */
    ...
    /**
     * Forwards a {@code Request} if it matches the criteria defined by the
     * SNMP-PROXY-MIB associated with this proxy forwarder.
     *
     * @param request
     *         a {@code ProxyForwardRequest} encapsuling the forwarding request.
     *
     * @return {@code true} if the request has been forwarded,
     ...
     *         be converted to the target PDU {@code target} is not changed.
     *         Instead an intermediate PDU is returned.
     *
     * @throws IllegalArgumentException
     *         if {@code source} contains an illegal notification PDU.
     */
