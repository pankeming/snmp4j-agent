...
//--AgentGen END
    ...
    private void createSnmpCommunityEntry() {
        ...
        snmpCommunityEntryColumns[idxSnmpCommunityName] =
                new MOMutableColumn<OctetString>(colSnmpCommunityName,
                        SMIConstants.SYNTAX_OCTET_STRING,
                        MOAccessImpl.ACCESS_READ_CREATE,
                        null,
                        true);
        snmpCommunityEntryColumns[idxSnmpCommunitySecurityName] =
                new MOMutableColumn<OctetString>(colSnmpCommunitySecurityName,
                        SMIConstants.SYNTAX_OCTET_STRING,
                        MOAccessImpl.ACCESS_READ_CREATE,
                        null,
                        true);
        ...
        snmpCommunityEntryColumns[idxSnmpCommunityContextName] =
                new MOMutableColumn<OctetString>(colSnmpCommunityContextName,
                        SMIConstants.SYNTAX_OCTET_STRING,
                        MOAccessImpl.ACCESS_READ_CREATE,
        ...
        snmpCommunityEntryColumns[idxSnmpCommunityTransportTag] =
                new MOMutableColumn<OctetString>(colSnmpCommunityTransportTag,
                        SMIConstants.SYNTAX_OCTET_STRING,
                        MOAccessImpl.ACCESS_READ_CREATE,
                        new OctetString(new byte[]{}),
                        true);
    ...
    private void createSnmpTargetAddrExtEntry() {
        ...
        snmpTargetAddrExtEntryColumns[idxSnmpTargetAddrTMask] =
                new MOMutableColumn<OctetString>(colSnmpTargetAddrTMask,
                        SMIConstants.SYNTAX_OCTET_STRING,
                        MOAccessImpl.ACCESS_READ_CREATE,
                        new OctetString(new byte[]{}),
                        true);
        ...
        snmpTargetAddrExtEntryColumns[idxSnmpTargetAddrMMS] =
                new MOMutableColumn<Integer32>(colSnmpTargetAddrMMS,
...
//--AgentGen END
    ...
    /**
     * The <code>SnmpCommunitySecurityNameValidator</code> implements the value validation for
     * <code>SnmpCommunitySecurityName</code>.
     */
    ...
    /**
     * The <code>SnmpCommunityContextEngineIDValidator</code> implements the value validation for
     * <code>SnmpCommunityContextEngineID</code>.
     */
    ...
    /**
     * The <code>SnmpCommunityContextNameValidator</code> implements the value validation for
     * <code>SnmpCommunityContextName</code>.
     */
    ...
    /**
     * The <code>SnmpCommunityTransportTagValidator</code> implements the value validation for
     * <code>SnmpCommunityTransportTag</code>.
     */
    ...
    /**
     * The <code>SnmpTargetAddrTMaskValidator</code> implements the value validation for
     * <code>SnmpTargetAddrTMask</code>.
     */
    ...
    /**
     * The <code>SnmpTargetAddrMMSValidator</code> implements the value validation for <code>SnmpTargetAddrMMS</code>.
     */
...
//--AgentGen BEGIN=_METHODS
    ...
    public boolean passesFilter(Address address,
        ...
        Collection<SnmpTargetAddrEntryRow> matches =
