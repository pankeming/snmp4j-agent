/*_############################################################################
  _## 
  _##  SNMP4J-Agent 3 - SubRequest.java  
  _## 
...
public interface SubRequest<N extends SubRequest<N>> {
     ...
     *
     * @return <code>true</code> if this request (and thus also this sub-request) has
     ...
     * </code>.
     *
     * @return a SNMPv2/v3 error status.
     * @since 1.0.1
     */
    int getErrorStatus();
     ...
     *
     * @return a RequestStatus instance.
     */
     ...
     *
     * @return a <code>MOScope</code> instance.
     */
    MOScope getScope();
     ...
     *
     * @return the <code>VariableBinding</code> that holds the sub-request result
     ...
     *
     * @return an Object that has previously been associated with this request by
     ...
     * processing.
     *
     * @return <code>true</code> if the sub-request has been finished and should not
     ...
     * this sub-request.
     *
     * @return <code>ManagedObject</code> instance.
     */
     ...
     *
     * @return a <code>MOQuery</code> that describes which manage objects match
     * this sub-request.
     */
    MOQuery getQuery();
     ...
     *
     * @return a SubRequestIterator enumerating the repetitions on this sub-requests
