 ...
 * operation requests.
 *
 * @param <S> source object that trigger the {@link Request} creation.
 * @param <R> the response object returned by this {@link Request}.
 * @param <U> the {@link SubRequest} sub-type used to process this request.
 *
 * @author Frank Fock
 * @version 1.2
 */
