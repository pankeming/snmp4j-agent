/*_############################################################################
  _## 
  _##  SNMP4J-Agent 3 - RequestHandler.java  
  _## 
...
/**
 * A request handler is able to process a request on behalf of the managed object repository represented by a {@link
 * MOServer}.
 *
 * @author Frank Fock
 * @version 1.0
...
public interface RequestHandler<R extends Request<?, ?, ?>> {
     ...
     *
     * @return <code>true</code> if the PDU type is supported.
     */
     ...
     * @param server
     *         a <code>MOServer</code> containing the managed objects accessible by the request.
     */
